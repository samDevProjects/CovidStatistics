 ...
 */
final class Version20201207224700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE records (id INT AUTO_INCREMENT NOT NULL, week_record INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE records_lab DROP FOREIGN KEY FK_CD3BFBEFEE8A0C7B');
        $this->addSql('ALTER TABLE records_hospital DROP FOREIGN KEY FK_A3B2DE01EE8A0C7B');
